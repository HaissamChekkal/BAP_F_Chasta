<?php
// $id doit êre l'ID de votre formulaire
$formId = 12;
...
<div class="row">
    <div class="col-xs-12">
        ...
        <section class="row">
            ...
            <div class="col-md-6 col-sm-8 half-height no-height-mobile bg-white pd-right-0">
                <div class="border">
                    <h2><?php the_title(); ?></h2>

                    <?php if($form->hasError()): ?>
                        <p><?php $form->theError(); ?></p>
                    <?php endif; ?>
                    ...
                    <?php
                    $form->open_the_form();
                    // Affiche le champ sendername
                    $form->the_form_field('sendername');
                    // Affiche le champ email
                    $form->the_form_field('email');
                    // Affiche le champ message
                    $form->the_form_field('message');
            ...
            <div class="col-md-3 col-sm-4 bg-white correct-bug-2 no-height-mobile half-height">
