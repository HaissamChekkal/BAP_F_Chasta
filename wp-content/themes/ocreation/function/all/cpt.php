...
function cpt_init(){
    // Valeurs entrées
    $nom = 'création';
    $menu_name = 'Univers'; // Nom du menu. Par défaut il prend la valeur de $nom
    $genre = 'F'; // Genre du mot F pour féminin, M pour masculin par défaut Masculin
    ...
    // REQUIS
    $nom = 'Type de création';
    $cpt = 'creation'; // Le custom post type auquel la catégorie est reliée

    // OPTIONNELS
    $menu_name = 'Type de création'; // S'il est vide, le menu aura le nom donné à $nom au pluriel
    $genre = ''; // Genre du mot F pour féminin, M pour masculin (par défaut Masculin)

    // INITIALISATION
    $result = init($nom,$menu_name,$genre);
    CreateCTXM($cpt,$result);
